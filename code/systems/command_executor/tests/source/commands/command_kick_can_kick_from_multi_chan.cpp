...
int main()
{
	...
	random_chan.user_join(&kicker);
	random_chan.user_join(&kickee_r);
	msg.message = parser.parse_string("KICK #bienvenida,#random vicmarti,tomartin");
	msg.sender = &user;
