...
/*   Updated: 2023/05/31 19:15:22 by javgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//--------------Time values config-----------------//
//--Time in seconds?-------------------------------//
#define	TIME_PING 60 //time need to kick when dont response a ping
#define	TIME_LAST_PING 60 //time need to respone a ping or kick
